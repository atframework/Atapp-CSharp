...
namespace AtappSimpleTest {
    class Program {
        ...
        static void log(LOG_LEVEL level, string content) {
            ...
            App.WriteLog(0, (uint)level, level.ToString(), frame.GetFileName(), frame.GetMethod().Name, (uint)frame.GetFileLineNumber(), content);
        }
        ...
        static int AppOnCommandTransfer(App self, byte[][] cmds) {
            ...
            app.SendData(dst_id, type, cmds[1], false);
            return 0;
        }
        ...
        static void Main(string[] args) {
            ...
            // setup command
            app.AddCustomCommand("echo", AppOnCommandEcho);
